...
var _this = this;
var _a = require('discord.js'), Client = _a.Client, Intents = _a.Intents, Guild = _a.Guild;
...
var sleep2 = function (ms) { return new Promise(function (resolve) { return setTimeout(resolve, ms); }); };
var _b = require('discord.js'), MessageActionRow = _b.MessageActionRow, MessageButton = _b.MessageButton, MessageEmbed = _b.MessageEmbed;
client.on('ready', function () {
    console.log("".concat(client.user.tag, "is online!"));
    client.user.setActivity('test now | ping:計測中...', { type: 'PLAYING' });
});
client.on('ready', function () {
    setInterval(function () {
        client.user.setActivity("test now | ping:".concat(client.ws.ping), { type: 'PLAYING' });
    }, 2500);
});
/////////////スラッシュコマンドー登録のやつ///////////////
